...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Spotchk Domexsum</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="spotchk_domexsum-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("spotchk_domexsum/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-dosing_time" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('dosing_time',""); ?>" type="time" name="dosing_time" placeholder="Enter Dosing Time" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                                <div class="input-group-append">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-ad"  value="<?php  echo $this->set_field_value('ad',""); ?>" type="text" placeholder="Enter A.D.%"  required="" name="ad"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-mc"  value="<?php  echo $this->set_field_value('mc',""); ?>" type="text" placeholder="Enter M.C.%"  required="" name="mc"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <select required=""  id="ctrl-perfume_impact" name="perfume_impact"  placeholder="Select a value ..."    class="custom-select" >
                                                                            ...
                                                                            $value = $option['value'];
                                                                            $label = $option['label'];
                                                                            $selected = $this->set_field_selected('perfume_impact', $value, "");
                                                                            ?>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <select required=""  id="ctrl-appearance" name="appearance"  placeholder="Select a value ..."    class="custom-select" >
                                                                            ...
                                                                            $value = $option['value'];
                                                                            $label = $option['label'];
                                                                            $selected = $this->set_field_selected('appearance', $value, "");
                                                                            ?>
                                                                            <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                                <?php echo $label ?>
                                                                            </option>                                   
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-bd"  value="<?php  echo $this->set_field_value('bd',""); ?>" type="text" placeholder="Enter BD gm/ml"  required="" name="bd"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-rm_seive"  value="<?php  echo $this->set_field_value('rm_seive',""); ?>" type="text" placeholder="Enter 20#RM Seive"  required="" name="rm_seive"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-fp_seive"  value="<?php  echo $this->set_field_value('fp_seive',""); ?>" type="text" placeholder="Enter 10#F.P Seive"  required="" name="fp_seive"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
