...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Inv</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("inv/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-truck"  value="<?php  echo $data['truck']; ?>" type="text" placeholder="Enter Truck"  required="" name="truck"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-mat"  value="<?php  echo $data['mat']; ?>" type="text" placeholder="Enter Mat"  required="" name="mat"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-material_type"  value="<?php  echo $data['material_type']; ?>" type="text" placeholder="Enter Material Type"  required="" name="material_type"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-bill_dt"  value="<?php  echo $data['bill_dt']; ?>" type="text" placeholder="Enter Bill Dt"  required="" name="bill_dt"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="input-group">
                                                                                    <input id="ctrl-grnd"  value="<?php  echo $data['grnd']; ?>" type="text" placeholder="Enter Grn"  required="" name="grnd"  class="form-control " />
                                                                                        <div class="input-group-append">
                                                                                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-invapp_qty"  value="<?php  echo $data['invapp_qty']; ?>" type="text" placeholder="Enter Inventory approval Qty"  required="" name="invapp_qty"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="input-group">
                                                                                                <input id="ctrl-po_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['po_date']; ?>" type="datetime" name="po_date" placeholder="Enter Po Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="d-m-Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                                                    <div class="input-group-append">
                                                                                                        <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                                    </div>
                                                                                                </div>
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-po_no"  value="<?php  echo $data['po_no']; ?>" type="text" placeholder="Enter Po No"  required="" name="po_no"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                <div class="col-sm-4">
                                                                                                    <label class="control-label" for="commercial_approval">Commercial Approval </label>
                                                                                                </div>
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <select  disabled id="ctrl-commercial_approval" name="commercial_approval"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                            <option value="">Select a value ...</option>
                                                                                                            <?php
                                                                                                            $commercial_approval_options = Menu :: $commercial_approval;
                                                                                                            $field_value = $data['commercial_approval'];
                                                                                                            if(!empty($commercial_approval_options)){
                                                                                                            foreach($commercial_approval_options as $option){
                                                                                                            $value = $option['value'];
                                                                                                            $label = $option['label'];
                                                                                                            $selected = ( $value == $field_value ? 'selected' : null );
                                                                                                            ?>
