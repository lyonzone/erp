...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Spotchk W</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("spotchk_w/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-product" name="product"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                <?php
                                                                $rec = $data['product'];
                                                                $product_options = $comp_model -> spotchk_w_product_option_list();
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="target_ad">Target A.D. <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-target_ad"  value="<?php  echo $data['target_ad']; ?>" type="text" placeholder="Enter Target A.D."  required="" name="target_ad"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="target_mc">Target M.C <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-target_mc"  value="<?php  echo $data['target_mc']; ?>" type="text" placeholder="Enter Target M.C"  required="" name="target_mc"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-shift" name="shift"  placeholder="Select a value ..."    class="custom-select" >
                                                                                ...
                                                                                <?php
                                                                                $rec = $data['shift'];
                                                                                $shift_options = $comp_model -> spotchk_w_shift_option_list();
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <label class="control-label" for="mixer_optr">Line Mixer OperatorMixer Optr <span class="text-danger">*</span></label>
                                                                    </div>
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-mixer_optr"  value="<?php  echo $data['mixer_optr']; ?>" type="text" placeholder="Enter Line Mixer OperatorMixer Optr"  required="" name="mixer_optr"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-addition" name="addition"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    ...
                                                                                    <?php
                                                                                    $rec = $data['addition'];
                                                                                    $addition_options = $comp_model -> spotchk_w_addition_option_list();
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-remarks" name="remarks"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    <option value="">Select a value ...</option>
                                                                                    <?php
                                                                                    $rec = $data['remarks'];
                                                                                    $remarks_options = $comp_model -> spotchk_w_remarks_option_list();
                                                                                    if(!empty($remarks_options)){
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-summary" name="summary"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    ...
                                                                                    <?php
                                                                                    $rec = $data['summary'];
                                                                                    $summary_options = $comp_model -> spotchk_w_summary_option_list();
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <label class="control-label" for="acid_purity">Acid Purity <span class="text-danger">*</span></label>
                                                                        </div>
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-acid_purity" name="acid_purity"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    <option value="">Select a value ...</option>
                                                                                    <?php
                                                                                    $rec = $data['acid_purity'];
                                                                                    $acid_purity_options = $comp_model -> spotchk_w_acid_purity_option_list();
                                                                                    if(!empty($acid_purity_options)){
                                                                                    foreach($acid_purity_options as $option){
                                                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                                    $selected = ( $value == $rec ? 'selected' : null );
                                                                                    ?>
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <label class="control-label" for="acid_colour">Acid Colour <span class="text-danger">*</span></label>
                                                                        </div>
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-acid_colour" name="acid_colour"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    <option value="">Select a value ...</option>
                                                                                    <?php
                                                                                    $rec = $data['acid_colour'];
                                                                                    $acid_colour_options = $comp_model -> spotchk_w_acid_colour_option_list();
                                                                                    if(!empty($acid_colour_options)){
                                                                                    foreach($acid_colour_options as $option){
                                                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                                    $selected = ( $value == $rec ? 'selected' : null );
                                                                                    ?>
