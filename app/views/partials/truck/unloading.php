                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="truck-unloading-records">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-truck_entry">
                                                    <span  data-flatpickr="{altFormat: 'd-m-Y H:i:s', minDate: '', maxDate: ''}" 
                                                        data-source='<?php print_link('api/json/truck_truck_entry_option_list'); ?>' 
                                                ...
                                                <td class="td-truck_no">
                                                    <span  data-value="<?php echo $data['truck_no']; ?>" 
                                                        data-pk="<?php echo $data['id'] ?>" 
                                                        data-url="<?php print_link("truck/editfield/" . urlencode($data['id'])); ?>" 
                                                        data-name="truck_no" 
                                                ...
                                                <td class="td-driver_mobile_no">
                                                    <span  data-value="<?php echo $data['driver_mobile_no']; ?>" 
                                                        data-pk="<?php echo $data['id'] ?>" 
                                                        data-url="<?php print_link("truck/editfield/" . urlencode($data['id'])); ?>" 
                                                        data-name="driver_mobile_no" 
                                                        data-title="Enter Driver Mobile No" 
                                                        data-placement="left" 
                                                        data-toggle="click" 
                                                        data-type="text" 
                                                        data-mode="popover" 
                                                        data-showbuttons="left" 
                                                        class="is-editable" >
                                                        <?php echo $data['driver_mobile_no']; ?> 
                                                    </span>
                                                </td>
                                                <td class="td-no_of_wheel">
                                                    <span  data-source='<?php print_link('api/json/truck_no_of_wheel_option_list'); ?>' 
                                                ...
                                                <td class="td-truck_exit">
                                                    <span  data-source='<?php echo json_encode_quote(Menu :: $truck_exit); ?>' 
                                                        data-value="<?php echo $data['truck_exit']; ?>" 
                                                        data-pk="<?php echo $data['id'] ?>" 
                                                        data-url="<?php print_link("truck/editfield/" . urlencode($data['id'])); ?>" 
                                                        data-name="truck_exit" 
