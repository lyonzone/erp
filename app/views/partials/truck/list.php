                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-material">
                                                    <?php
                                                    $page_fields = array('date' => $data['truck_entry'],'vehicle' => $data['truck_no'],'transporter' => $data['transporter']);
                                                    $page_link = "masterdetail/index/truck/unloading_materials/date/" . urlencode($data['truck_entry']);
                                                    ...
                                                    <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link($md_pagelink) ?>">
                                                        <i class="fa fa-eye"></i> <?php echo $data['material'] ?>
                                                    </a>
                                                </td>
