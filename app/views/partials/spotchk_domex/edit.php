...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Spotchk Domex</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("spotchk_domex/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-product" name="product"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                <?php
                                                                $rec = $data['product'];
                                                                $product_options = $comp_model -> spotchk_domex_product_option_list();
                                                        ...
                                                        <div class="form-group ">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-shift" name="shift"  placeholder="Select a value ..."    class="custom-select" >
                                                                                ...
                                                                                <?php
                                                                                $rec = $data['shift'];
                                                                                $shift_options = $comp_model -> spotchk_domex_shift_option_list();
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <label class="control-label" for="submitted_by">Submitted By <span class="text-danger">*</span></label>
                                                                        </div>
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-submitted_by"  value="<?php  echo $data['submitted_by']; ?>" type="text" placeholder="Enter Submitted By"  required="" name="submitted_by"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-addition" name="addition"  placeholder="Select a value ..."    class="custom-select" >
                                                                                        ...
                                                                                        <?php
                                                                                        $rec = $data['addition'];
                                                                                        $addition_options = $comp_model -> spotchk_domex_addition_option_list();
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-summary" name="summary"  placeholder="Select a value ..."    class="custom-select" >
                                                                                        ...
                                                                                        <?php
                                                                                        $rec = $data['summary'];
                                                                                        $summary_options = $comp_model -> spotchk_domex_summary_option_list();
