...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Soda Ash Light</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-truck_entry">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['truck_entry']; ?>" 
                                                ...
                                                data-url="<?php print_link("soda_ash_light/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-B_VALUE">
                                        <th class="title"> B Value: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['B_VALUE']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("soda_ash_light/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="B_VALUE" 
                                                data-title="Enter B Value" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['B_VALUE']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-SODIUM_BICARBONATE">
                                        <th class="title"> Sodium Bicarbonate: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['SODIUM_BICARBONATE']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("soda_ash_light/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="SODIUM_BICARBONATE" 
                                                data-title="Enter Sodium Bicarbonate" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['SODIUM_BICARBONATE']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-SODIUM_CHLORIDE">
                                        <th class="title"> Sodium Chloride: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['SODIUM_CHLORIDE']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("soda_ash_light/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="SODIUM_CHLORIDE" 
                                                data-title="Enter Sodium Chloride" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-VOL_OF_IN_H2SO4">
                                        <th class="title"> Vol Of In H2so4: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['VOL_OF_IN_H2SO4']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("soda_ash_light/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="VOL_OF_IN_H2SO4" 
                                                data-title="Enter Vol Of In H2so4" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-RETT_ON_60">
                                        <th class="title"> Rett On 60: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['RETT_ON_60']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("soda_ash_light/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="RETT_ON_60" 
                                                data-title="Enter Rett On 60" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("soda_ash_light/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("soda_ash_light/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
