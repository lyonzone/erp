                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-user_role"> User Role</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-user_name"> <?php echo $data['user_name']; ?></td>
                                                    ...
                                                    <td class="td-registration_date"> <?php echo $data['registration_date']; ?></td>
                                                    <td class="td-user_role"> <?php echo $data['user_role']; ?></td>
