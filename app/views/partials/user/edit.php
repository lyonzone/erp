                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-user_name"  value="<?php  echo $data['user_name']; ?>" type="text" placeholder="Enter User Name"  required="" name="user_name"  data-url="api/json/user_user_name_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <div class="dropzone " input="#ctrl-signature" fieldname="signature"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                        <input name="signature" id="ctrl-signature" class="dropzone-input form-control" value="<?php  echo $data['signature']; ?>" type="text"  />
                                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                            <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                        </div>
                                                                    </div>
