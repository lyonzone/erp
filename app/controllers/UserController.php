...
class UserController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				user.email LIKE ? OR 
				user.photo LIKE ? OR 
				user.registration_date LIKE ? OR 
				user.user_role LIKE ? OR 
				user.signature LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("user_name","password","phone","email","photo","registration_date","user_role","signature","account_status");
			...
			$this->sanitize_array = array(
				...
				'user_role' => 'sanitize_string',
				'signature' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","user_name","password","phone","email","photo","signature");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
