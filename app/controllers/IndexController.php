...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("user_name","password","phone","email","photo","registration_date","user_role","signature","account_status"); //registration fields
			...
			$date_to_expire = format_date("1 month");
