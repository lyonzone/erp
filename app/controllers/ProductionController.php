 ...
 * @category  Controller
 */
class ProductionController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				production.id LIKE ? OR 
				production.enter_prod LIKE ?
			)";
			$search_params = array(
				"%$text%","%$text%"
			);
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("production.id", ORDER_TYPE);
		}
		if($fieldname){
		...
		$this->render_view("production/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("production.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("enter_prod");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'enter_prod' => 'required',
			);
			$this->sanitize_array = array(
				'enter_prod' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","enter_prod");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'enter_prod' => 'required',
	...
	function delete($rec_id = null){
		...
		$db->where("production.id", $arr_rec_id, "in");
